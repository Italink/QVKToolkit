...
**
****************************************************************************/
#ifndef QVKWindowPrivate_h__
#define QVKWindowPrivate_h__
...
class  QVKWindowPrivate : public QWindowPrivate
{
	Q_DECLARE_PUBLIC(QVKWindow)
...
public:
	...
	QVKWindow::QueueCreateInfoModifier queueCreateInfoModifier;
	...
	static const int MAX_FRAME_LAG = QVKWindow::MAX_CONCURRENT_FRAME_COUNT;
	// QVKWindow only supports the always available FIFO mode. The
	...
	bool swapChainSupportsWriteBack = false;
